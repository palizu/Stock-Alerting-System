...
# Message
UNSUPPORTED_CONDITION_MSG = "Unsupported condition: " 
UNSUPPORTED_TICKER_MSG = "Unsupported ticker: "
NEGATIVE_THRESHOLD_MSG = "Hmmm... kind of stupid if a threshold is negative right? Please enter a positive threshold"
WELCOME_MESSAGE = """
Welcome to vanhtaStockAlertingBot.

This bot helps you to stay up to date with what is going on in the stock market.
You can create alert with this bot, and once the conditions is met, he will send you a message.
Try create alert now with /add.
...
/add - add a new alerting condition
/update - update existing alerting condition
/remove - remove an alerting condition
/list - view all of your alert condition
/cancel - stop receiving alerts and delete all conditions

This bot only support alert on PRICE, RSI, MA20, MA50, MACD. 
For MACD, alerts will be sent when MACD cross SIGNAL_LINE.
FOR others, if value reached your set up threshold, the bot will send you an alert, and if the value continue increase/decrease, it will also send you alert.

Got feedback? Contact me at: van.hta170224@sis.hust.edu.vn
"""
NO_CONDITION_MESSAGE = "You have no alert yet. Create one with /add"
...
# alert message
GT_MESSAGE = "Alert on {}: {} went above your theshold!!\nCurrent price: {}"
LT_MESSAGE = "Alert on {}: {} went under your theshold!!\nCurrent price: {}"
